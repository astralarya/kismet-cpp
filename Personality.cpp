...
Personality::response_pool Personality::_name_response
   {"<3","<3","<3","<3","<3","<3","<3","<3","<3","<3","<3","<3",
    ...
    "Howdy", "Howdy!", "YEEEHAAAWWW!!!", "Fire in the hole!", "FIRE!!",
    "oops", "Oops..", "Oops I did it again",
    ...
    "<silence>", "*crickets*", "*meow*", "*mrow*", "*mewls*", "*prrrr*",
    "Oh dear...", "Oh my!", "Kekekekekeke", "Leave me alone", "Let me go!",
    "Go away", "I hate you", "rude", 
    "Stop", "Stop.", "Stop!", "Stop touching me!", "STOP", "<full stop>",
    "SOS", "Please", "please", "pleease?", "Don't go", "I still love you", "You should stay forever",
    "Do you like candy?", "Candy?", "CANDY!", "blah blah", "blah",
